...
const DEMO_SLOTS = [
  {
    ...
    z: 0,
    documentUrl: `ws://localhost:8080/examples/collision-events.html`,
    title: "Collision Events Demo",
  },
  {
    x: (SLOT_WIDTH + SPACE_BETWEEN_SLOTS) * -2,
    z: SPACE_BETWEEN_SLOTS + SLOT_DEPTH,
    documentUrl: `ws://localhost:8080/examples/position-probe.html`,
    title: "m-position-probe Demo",
  },
  {
    x: (SLOT_WIDTH + SPACE_BETWEEN_SLOTS) * -1,
    z: 0,
    documentUrl: `ws://localhost:8080/examples/duck.html`,
    title: "Rotating Duck",
  },
  {
    x: (SLOT_WIDTH + SPACE_BETWEEN_SLOTS) * -1,
    z: SLOT_DEPTH + SPACE_BETWEEN_SLOTS,
    documentUrl: `ws://localhost:8080/examples/dice.html`,
    title: "Interactive Dice",
  },
  {
    x: (SLOT_WIDTH + SPACE_BETWEEN_SLOTS) * -1,
    z: (SLOT_DEPTH + SPACE_BETWEEN_SLOTS) * 2,
    documentUrl: `ws://localhost:8080/examples/videoplayer.html`,
    title: "Video Player",
  },
  {
    x: (SLOT_WIDTH + SPACE_BETWEEN_SLOTS) * -1,
    z: (SLOT_DEPTH + SPACE_BETWEEN_SLOTS) * 3,
    documentUrl: `ws://localhost:8080/examples/weather.html`,
    title: "Weather API",
  },
  {
    x: (SLOT_WIDTH + SPACE_BETWEEN_SLOTS) * -1,
    z: (SLOT_DEPTH + SPACE_BETWEEN_SLOTS) * 4,
    documentUrl: `http://localhost:8080/assets/static-mml.html`,
    title: "Static MML",
  },
];
